...
public class MainActivity extends Activity {
	...
	public void onClick(View v) {
		...
		if (id == R.id.sos_button) {
			...
			//Intent i = new Intent();
		    //i.setClassName("com.example.e_contact1", "com.example.e_contact1.Maps");
		    //i.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
		    //startActivity(i);
		    
			Intent hospital = new Intent(MainActivity.this, Maps.class);
			hospital.putExtra("key", HOSPITAL);
			startActivity(hospital);
		} else if (id == R.id.ambulance_button) {
			Intent ambulance = new Intent(MainActivity.this, com.example.e_contact1.Maps.class);
